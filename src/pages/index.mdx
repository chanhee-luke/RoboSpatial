...
| **Open-source**             |                 |                  |               |              |
| *--2D--*                    |                 |                  |               |              |
| LLaVA-NeXT                  | 30.3            | 43.9             | 71.8          |    55.9      |
| + RoboSpatial               | 60.5            | 58.7             | **79.0**      |    **70.6**      |
| RoboPoint                   | 38.9            | 47.3             | 63.6          |    44.1      |
| + RoboSpatial               | 70.6            | **60.0**         | 70.6          |    64.7      |
| *--3D--*                    |                 |                  |               |              |
| Embodied Generalist         | 42.8            | 29.8             | N/A           |    N/A       |
| + RoboSpatial               | **71.9**        | 43.8             | N/A           |    N/A       |
| **Baselines**               |                 |                  |               |              |
| Molmo                       | 50.1            | 24.5             | 67.1          |    55.9      |
| GPT-4o                      | 50.8            | 45.3             | 76.2          |    **70.6**      |
